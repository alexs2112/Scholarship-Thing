...
public class Data implements Serializable {
	...
	public Data() {
		...
		awards.add(new Scholarship("TestScholarship1", "Donor One", 600, "Annual", 3.4, 400, "None", "None", "None"));
		awards.add(new Scholarship("TestScholarship2", "Donor Two", 800, "Fall", 3.6, 300, "None", "None", "None"));
		awards.add(new Scholarship("TestScholarship3", "Donor Three", 1000, "Winter", 3.8, 200, "None", "None", "None"));
	}
